...
class Ai():
    def __init__(self):
        ...
        self.speech_pub = rospy.Publisher("/api_ai/speech_output",String,queue_size = 1)
        self.action_pub = rospy.Publisher("/api_ai/action",String,queue_size = 1)
        self.chat_pub 	= rospy.Publisher("/chat_bot/chat_input",String,queue_size = 1)
        self.ai         = apiai.ApiAI(CLIENT_ACCESS_TOKEN)
        self.rate       = rospy.Rate(1)
        rospy.Subscriber("/speech_recognition/speech",String,self.speech_callback)
